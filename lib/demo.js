...
class Demo {
  ...
  playDemo() {
    ...
    let firework1 = new Firework(null, (demoCanvas.width * 0.8), (demoCanvas.height * 0.3));
    firework1.initiate();
    ...
    let firework4 = new Firework([[1, 255, 1]], (demoCanvas.width * 0.4), (demoCanvas.height * 0.2));
    firework4.initiate();

    let firework5 = new Firework([[255, 102, 1]], (demoCanvas.width * 0.3), (demoCanvas.height * 0.8));
    firework5.initiate();

    let firework6 = new Firework([[255, 102, 1]], (demoCanvas.width * 0.6), (demoCanvas.height * 0.3));
    firework6.initiate();
