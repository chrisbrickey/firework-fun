...
class Demo {
  ...
  playDemo() {
    ...
    let firework5 = new Firework([[255, 51, 153]], (demoCanvas.width * 0.3), (demoCanvas.height * 0.8), this.sound);
    firework5.initiate();

    let firework6 = new Firework([[1, 102, 255]], (demoCanvas.width * 0.6), (demoCanvas.height * 0.4), this.sound);
    firework6.initiate();
