...
document.addEventListener('DOMContentLoaded', () => {
  ...
  let record1 = new Record(mainCanvas, button1,[[255, 102, 1]]);
  record1.listenToButton();

  let button2 = document.getElementById("F2");
  let record2 = new Record(mainCanvas, button2,[[255, 255, 1]]);
  record2.listenToButton();

  let button3 = document.getElementById("F3");
  let record3 = new Record(mainCanvas, button3,[[1, 255, 1]]);
  record3.listenToButton();

  let button4 = document.getElementById("F4");
  let record4 = new Record(mainCanvas, button4,[[1, 102, 255]]);
  record4.listenToButton();

  let button5 = document.getElementById("F5");
  let record5 = new Record(mainCanvas, button5,[[255, 51, 153]]);
  record5.listenToButton();

  let button6 = document.getElementById("F6");
  let record6 = new Record(mainCanvas, button6,[[255, 1, 1], [1, 255, 1], [1, 1, 255]]);
