  ...
  _createClass(Firework, [{
    ...
    value: function buildPelletArray() {
      ...
      for (var i = 0; i < 200; i++) {
        ...
        //creates new pellet
        var pellet = new Pellet(x, y, load, this.colors[Math.floor(i % numColors)]);
        var reach = this.fireworkInnerRadius + 20 + Math.random() * 80;
        pellet.innerX = x;
