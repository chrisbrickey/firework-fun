...
var Firework = function () {
  ...
  _createClass(Firework, [{
    ...
    value: function animateWithLoopNew() {
      ...
      var x = this;
      var fade = 0;
      var magnitude = 10; //this appears to only be used on the first iteration
      var gravity = -0.1;
      var counter = 0;
      ...
      var z = setInterval(function () {
        ...
        for (var i = 0; i < x.pelletArray.length; i++) {
          ...
          var group = i % 6; //divides pellets into 6 groups (0 through 5) - pellets remain in the same group through all intervals b/c based on i

          if (true) {

            //assigns theta based on group (6 groups) at 0rad, pi/3 rad, 2pi/3 rad, pi rad, 4 pi/3 rad, 5 pi/3 rad, 2 pi rad
            var theta = group * Math.PI / 3;
