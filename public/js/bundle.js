...
var Firework = function () {
  function Firework(colorArray, Xcoor, Ycoor, sound) {
    ...
    this.animateWithLoopStarburst = this.animateWithLoopStarburst.bind(this);
  ...
  _createClass(Firework, [{
    ...
    value: function buildPelletArray(startX, startY) {
      ...
      for (var i = 0; i < 500; i++) {
        ...
        var p = Math.random(); //Random number 0 -> 1
        ...
        var x = startX + fireworkInnerRadius * Math.cos(2 * Math.PI * p);
        var y = startY + fireworkInnerRadius * Math.sin(2 * Math.PI * p);
        ...
        var pellet = new Pellet(x, y, pelletRadius, colorValues[0], colorValues[1], colorValues[2], alpha);
        this.pelletArray.push(pellet);
      }
    }
  }, {
    key: "animateWithLoopStarburst",
    value: function animateWithLoopStarburst() {
      var x = this;
      var viewWidth = document.documentElement.clientWidth;
      var viewHeight = document.documentElement.clientHeight;

      //next step: adjust canvas to size of pellet
      ...
      //inputs to loop
      var fade = 0;
      var magnitude = 1; //this appears to only be used on the first iteration
      var gravity = -1;
      var counter = 0;
      ...
      var z = setInterval(function () {
        ...
        for (var i = 0; i < x.pelletArray.length; i++) {
          ...
          var angleGroup = i % divisor; //divides pellets into groups - pellets remain in the same group through all intervals b/c based on i

          if (true) {
            //assigns theta based on group; if 6 groups... at 0rad, pi/3 rad, 2pi/3 rad, pi rad, 4 pi/3 rad, 5 pi/3 rad, 2 pi rad
            var theta = angleGroup * 2 * Math.PI / divisor;
    ...
    } //end of animateWithLoopStarburst


  }, {
    key: "animateWithLoopCushion",
    value: function animateWithLoopCushion() {
      ...
      var z = setInterval(function () {
        ...
        for (var i = 0; i < x.pelletArray.length; i++) {
          ...
          if (true) {
            ...
            if (changeY > 100) {
              var modifiedY = changeY * Math.random();
              changeY = modifiedY;
            }
          }
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var demo = new Demo(demoButton, fireworkSound);
  demo.listenToButton();
...
var Demo = function () {
  ...
  _createClass(Demo, [{
    ...
    value: function playDemo() {
      ...
      var firework5 = new Firework([[255, 51, 153]], demoCanvas.width * 0.3, demoCanvas.height * 0.8, this.sound);
      firework5.initiate();

      var firework6 = new Firework([[1, 102, 255]], demoCanvas.width * 0.6, demoCanvas.height * 0.4, this.sound);
      firework6.initiate();
...
var Record = function () {
  function Record(canvas, context, button, colorArray, display, sound) {
    ...
    this.bustImage.src = "https://res.cloudinary.com/dckkkjkuz/image/upload/v1501871190/fireworks/bust.png";
